          ...
          <div className='relative'>
            ...
            <div className='mx-auto max-w-7xl text-justify text-base leading-relaxed text-gray-700 md:text-lg'>
              ...
              <span className='mb-4 block'>
                Bayangkan setiap pagi, si kecil tumbuh lebih ceria, fokus
                belajar, dan cepat tangkap. Itulah manfaat yang terkandung dalam
                ...
                <em>kemampuan berpikir</em> dan <em>berbicara anak</em> sejak
                dini secara optimal.
              </span>
